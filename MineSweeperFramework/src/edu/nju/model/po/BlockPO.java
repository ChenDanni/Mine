...
public class BlockPO {
	...
	public BlockVO getDisplayBlock(GameState gameState){
		...
		if(state == BlockState.CLICK&&(!isMine)){
			...
			else dbs = DisplayBlockState.FLAG;
//		}else if (OperationQueue.nowOperation.getClientSourse()) {
//	System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa : "+OperationQueue.nowOperation.getClientSourse());
//			dbs = DisplayBlockState.CLIENT_FLAG;
		}
